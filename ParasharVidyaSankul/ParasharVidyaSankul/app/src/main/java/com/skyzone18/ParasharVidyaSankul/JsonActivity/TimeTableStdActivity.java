...
import com.skyzone18.ParasharVidyaSankul.Adapter.TimeTableStandardAdapter;
...
public class TimeTableStdActivity extends AppCompatActivity {
    ...
    private void getstander(String stdid) {
        pDialog = new ProgressDialog(TimeTableStdActivity.this);
        ...
        call.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, retrofit2.Response<Example> response) {
                ...
                // Toast.makeText(TimeTableStdActivity.this, response.body().getData().get(1).getStdId(), Toast.LENGTH_LONG).show();

                if (response.body().getData().size() == 0) {
                    ivnotfound.setVisibility(View.VISIBLE);
                    recyclerView.setVisibility(View.GONE);
                } else {
                    recyclerView.setAdapter(new TimeTableStandardAdapter(TimeTableStdActivity.this, (ArrayList<Datum>) dataitem));
                }
            ...
            public void onFailure(Call<Example> call, Throwable t) {
                Log.e(">>>>>>", t.toString());
                Toast.makeText(TimeTableStdActivity.this, "Try Again", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
