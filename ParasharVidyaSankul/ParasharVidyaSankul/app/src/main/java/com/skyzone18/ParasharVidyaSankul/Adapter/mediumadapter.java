...
public class mediumadapter extends RecyclerView.Adapter<mediumadapter.ViewHolder> {
    ...
    public void onBindViewHolder(final mediumadapter.ViewHolder holder, final int position) {
        final String title = mediumlist.get(position).getName();
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String name = mediumlist.get(position).getName();
                String  pos = mediumlist.get(position).getMediumId();
                Intent i = new Intent(view.getContext(), TimeTableStdActivity.class);
                i.putExtra("STDID", pos);
