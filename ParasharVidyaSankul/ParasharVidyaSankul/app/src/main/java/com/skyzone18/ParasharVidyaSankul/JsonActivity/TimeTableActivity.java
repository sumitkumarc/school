...
import com.skyzone18.ParasharVidyaSankul.Adapter.TimeTableViewadapter;
...
public class TimeTableActivity extends AppCompatActivity {
    ...
    public void news(String stdid) {
        pDialog = new ProgressDialog(TimeTableActivity.this);
        pDialog.setIndeterminate(false);
        pDialog.setCancelable(false);
        pDialog.show();
        Call<Example> call = apiService.GetTimeTable(stdid);
        call.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, retrofit2.Response<Example> response) {
                ...
                if (response.body().getData().size() == 0) {
                    ...
                    recyclerView.setAdapter(new TimeTableViewadapter(TimeTableActivity.this, items));
                }
