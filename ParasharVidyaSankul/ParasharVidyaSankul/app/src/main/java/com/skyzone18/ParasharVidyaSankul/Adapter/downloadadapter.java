...
import com.skyzone18.ParasharVidyaSankul.Model.CheckForSDCard;
...
public class downloadadapter extends RecyclerView.Adapter<downloadadapter.ViewHolder> {
    ...
    public void onBindViewHolder(final downloadadapter.ViewHolder holder, final int position) {
        ...
        holder.download_name.setText(downloadlist.get(position).getTital());
        ...
        holder.download_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(downloadlist.get(position).getAssignments().toString()));
