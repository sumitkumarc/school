...
import com.skyzone18.ParasharVidyaSankul.JsonActivity.ShowPhotodActivity;
...
public class galleryadapter extends RecyclerView.Adapter<galleryadapter.ViewHolder> {
    ...
    public void onBindViewHolder(final galleryadapter.ViewHolder holder, final int position) {
        ...
        final String title = gallerylist.get(position).getName();
...
//        Log.e(">>>>>>", title);
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String pos = gallerylist.get(position).getCatagoryId();
                String CATNAME = gallerylist.get(position).getName();
